...
namespace adc.Services.Base {
    public interface IBaseService<TEntity, TDto> where TEntity : class, IEntity where TDto : class, IDto {
        ...
        /// <summary>
        /// Create list of records use Bulk operations
        /// </summary>
        /// <param name="models"></param>
        /// <returns></returns>
        void CreateBulk(List<TDto> models, BulkConfig bulkConfig = null);
        ...
        /// <summary>
        /// Update list of records use Bulk operations
        /// </summary>
        /// <param name="models"></param>
        /// <returns></returns>
        void UpdateBulk(List<TDto> models, BulkConfig bulkConfig = null);
        ...
        /// <summary>
        /// Updates the specified predicate with grouping.
        /// </summary>
        /// <param name="predicate">The predicate.</param>
        /// <param name="groupSize">Update values group size.</param>
        /// <param name="includes">The includes.</param>
        /// <param name="action">The action.</param>
        /// <returns></returns>
        List<TDto> Update(Expression<Func<TEntity, bool>> predicate, int groupSize, IEnumerable<Expression<Func<TEntity, object>>> includes = null, Action<TEntity> action = null);
